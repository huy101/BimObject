    ...
    <div className='flex min-h-screen'>
      ...
      <div className='flex w-full items-center justify-center lg:w-1/2'>
        <div className='w-full max-w-md px-6'>
          ...
          <h1 className='mb-4 text-center text-3xl font-bold'>Sign up for Bim.com</h1>
          ...
          <div className='space-y-4'>
            ...
            <div className='space-y-4'>
              ...
              <div className='space-y-3'>
                ...
                <div className='flex items-start'>
                  <input
                    ...
                    onChange={(e) => setCommunicationOptIn(e.target.checked)}
                  />
                  <label htmlFor='communications' className='ml-2 text-sm text-gray-600'>
              ...
              <Button className='w-full bg-green-600 py-6 text-white hover:bg-green-700'>Create account</Button>

              <p className='text-center text-sm text-gray-600'>
                Already have an account?{' '}
                <Link to='/login' className='font-medium text-gray-900 hover:text-green-700'>
                  Log in
                </Link>
              </p>
            </div>
